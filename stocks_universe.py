...
NIFTY_50 = [
    ...
    "NTPC.NS", "ULTRACEMCO.NS", "BAJAJFINSV.NS", "HCLTECH.NS", "TATAMOTORS.NS",
    ...
    "TATACONSUM.NS", "TATASTEEL.NS", "TECHM.NS", "BAJAJ-AUTO.NS", "BPCL.NS",
...
NIFTY_NEXT_50 = [
    ...
    "LUPIN.NS", "MARICO.NS", "MCDOWELL-N.NS", "MUTHOOTFIN.NS",
...
HIGH_MOMENTUM_MIDCAP = [
    ...
    "EXIDEIND.NS", "GMRINFRA.NS", "INDIANB.NS", "IRCTC.NS",
    ...
    "SUPREMEIND.NS", "TVSMOTOR.NS", "ZOMATO.NS",
]
...
SECTOR_MAP = {
    ...
    "JUBLFOOD.NS": "FMCG", "ZOMATO.NS": "FMCG",
    ...
    "ADANITRANS.NS": "Infra", "CONCOR.NS": "Infra", "GMRINFRA.NS": "Infra",
    ...
    "EXIDEIND.NS": "Industrial", "SRF.NS": "Industrial", "MCDOWELL-N.NS": "Industrial",
    "UPL.NS": "Industrial",
}
